...
今回のケースでは **「サブのゴルーチンが durably block になるの止まっていると、durably block になることなくサブのゴルーチンが終了してしまった」** ということになります。
...
先んじてこの内容を社内に向けて公開したところ「exponential backoff でリトライしているコードに」
